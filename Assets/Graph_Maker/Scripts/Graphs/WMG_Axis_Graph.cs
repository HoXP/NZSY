...
public class WMG_Axis_Graph : WMG_Graph_Manager
{
    ...
    public bool IsStacked
    {
        get
        {
            return (graphType == graphTypes.bar_stacked
                    || graphType == graphTypes.bar_stacked_percent
                    || graphType == graphTypes.line_stacked);
        }
    }
    ...
    {
        GraphBackgroundChanged?.Invoke(this);
    }
    ...
    public List<float> TotalPointValues { get; } = new List<float>();
